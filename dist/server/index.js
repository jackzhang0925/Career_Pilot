...
function getDraftSecret() {
	return "71de0369-9146-427d-a9f6-4a41428f6cdc";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "43685edb-9060-4e92-914d-00b5a6d568aa";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "43685edb-9060-4e92-914d-00b5a6d568aa") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "43685edb-9060-4e92-914d-00b5a6d568aa",
		rootBoundaryId
	});
}
/**
