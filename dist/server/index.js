globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/career-dashboard-D9kabJhP.js","assets/lib-B3X-f5Gv.js","assets/pdf-F7PTmMg3.js","assets/layout-segment-context-DYLcNO_m.js"];
...
function getDraftSecret() {
	return "744e43e6-2ddb-4d4e-af42-400a99bff888";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "06f5ae41-315f-4fdc-a98d-8cd512d92f9e";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "06f5ae41-315f-4fdc-a98d-8cd512d92f9e") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "06f5ae41-315f-4fdc-a98d-8cd512d92f9e",
		rootBoundaryId
	});
}
/**
