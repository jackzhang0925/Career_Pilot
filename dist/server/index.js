globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/career-dashboard-D4Cgzp3P.js","assets/lib-B3X-f5Gv.js","assets/pdf-aeABD3_h.js","assets/layout-segment-context-va_7iDxG.js"];
...
function getDraftSecret() {
	return "b8d3ab4b-4346-418c-b4be-d3c4f0846731";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "3298a5f9-db38-4a25-9b21-37b5ff2897e0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "3298a5f9-db38-4a25-9b21-37b5ff2897e0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "3298a5f9-db38-4a25-9b21-37b5ff2897e0",
		rootBoundaryId
	});
}
/**
...
async function GET$1() {
	...
	return Response.json({
		...
		model: runtime?.model || process.env.OPENAI_MODEL || "gpt-5.6"
	});
}
...
async function POST(request) {
	...
	const batches = await Promise.allSettled([...greenhouseBoards.map((source) => fetchGreenhouse(source.company, source.board)), fetchCohere()]);
	...
	return Response.json({
		...
		sources: batches.filter((batch) => batch.status === "fulfilled").length
	});
}
//#endregion
