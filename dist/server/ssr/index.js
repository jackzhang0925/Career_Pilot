...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-CoE10gR3.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"29b5d3f650f6": async () => {
		const m = await import("./assets/career-dashboard-BgAO-VyN.js");
		return { get "CareerDashboard"() {
			return m["CareerDashboard"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-ZkST6QQy.js");
		return {
			get "ErrorBoundary"() {
